...
public class InvertedIndexMultimapBenchmark {
    ...
    @Benchmark
    public static void InvertedIndexMultimapConsult() throws URISyntaxException, IOException {
        executeWith(new InvertedIndexBuilder(new GutenbergTokenizer()));
    }

    private static void executeWith(InvertedIndexBuilder builder) throws URISyntaxException, IOException {
        ...
        InvertedIndex index = builder.build(document);
